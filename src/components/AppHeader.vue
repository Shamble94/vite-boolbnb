      ...
      <div class="row">
        ...
        <div class="col-3">
          <div class="content">
            ...
            <span class="mx-3 ms-5">Home</span>
        ...
        <div class="col-6 align-items-center d-flex justify-content-center">
          <div class="searchbar" ref="searchbar">
            ...
            <i class="search icons-searchbar">
              <svg fill="#bbbbbb" height="20px" width="20px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 488.4 488.4" xml:space="preserve">
                <g>
	                <g>
        ...
        <div class="col-3 align-items-center d-flex justify-content-center">
          ...
          <button type="button" class="vendor-button">
