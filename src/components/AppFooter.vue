        ...
        <div class="container">
            <div class="row">
                <div class="col-6 col-xl-4">
                    <div class="content">
                        ...
                        <div>
                            <p class="text-white fs-5">Trova l'appartamento perfetto per te!</p>
                        </div>

                        <h2 class="fs-3 mt-5">Contattaci</h2>
                        <ul class="list-unstyled">
                            <li>Dove trovarci</li>
                            <li>I nostri contatti</li>
                            <li>Chi siamo</li>
                            <li>info@boolbnb.com</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-6 col-xl-2 ">
                    <div class="content">
                        <h2>Contattaci</h2>
                        <ul class="list-unstyled">
                            <li>+39 355 545 5555</li>
                            <li>info@boolbnb.com</li>
                            <li>Termini e condizioni</li>
                            <li>
                                <i class="fa-brands fa-facebook me-3 mt-4 fs-3"></i>
                                <i class="fa-brands fa-instagram me-3 mt-4 fs-3"></i>
                                <i class="fa-brands fa-google-plus me-3 mt-4 fs-3"></i>
                                <i class="fa-brands fa-twitter me-3 mt-4 fs-3"></i>
                            </li>
            ...
            <div class="col-12">
                <div class="content d-flex justify-content-center">
                    <span class="text-align-center">2024 &copy; Copyright Boolbnb</span>
                </div>
            </div>
        </div>
    </footer>
